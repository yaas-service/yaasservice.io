...
# 7️⃣ Clear Old Aliases from Vercel
echo "🗑️ Clearing Old Aliases from Vercel..."
vercel alias ls --scope yaas-services-projects | awk '{print $2}' | grep 'vercel.app' | xargs -I % vercel alias rm % --yes

# 8️⃣ Redeploy to Vercel
...
dig yaasservice.io +short
dig www.yaasservice.io +short
