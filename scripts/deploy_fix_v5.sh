...
# 7️⃣ Remove Domain from Vercel
echo "🗑️ Removing Domain from Vercel..."
vercel domains rm yaasservice.io --yes
vercel domains rm www.yaasservice.io --yes

# 8️⃣ Re-add Domain to Vercel
echo "➕ Re-adding Domain to Vercel..."
vercel domains add yaasservice.io
vercel domains add www.yaasservice.io
